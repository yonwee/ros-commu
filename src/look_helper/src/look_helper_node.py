...
if __name__ == '__main__':
    ...
    euclid_t_x = rospy.get_param('look_helper/euclid_tx', -0.11)
    euclid_t_y = rospy.get_param('look_helper/euclid_ty', 0.33)
    euclid_t_z = rospy.get_param('look_helper/euclid_tz', 0.11)
    ...
    webcam_t_x = rospy.get_param('look_helper/webcam_tx', 0.27)
    webcam_t_y = rospy.get_param('look_helper/webcam_ty', -0.02)
    webcam_t_z = rospy.get_param('look_helper/webcam_tz', 0.13)
